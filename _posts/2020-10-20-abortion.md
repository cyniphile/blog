...
Few publications are balanced, and some of the most mainstream papers are very heavy on pro-choice rhetoric. For example, only 25% of articles from the New York Times used a net right-of-center lexicon. The Washington Post was much more balanced, and the Bismarck Tribune (from pro-life North Dakota) was extremely right-leaning in its relatively small sample of articles (click on the "scatter plot" option to see individual articles). 
...
Given the intense moral quandary, is it beneficial to the pro-choice movement (or even morally sound in general) to die on the hill of federally unrestricted late-term abortion? How quickly would early-term abortion rights advance if there was nothing for Trump to rant about in this regard? Conversely, should pro-lifers be willing to die on the hill of limiting access to early-term abortion? While many hold religious beliefs that life is sacred from conception, even if it is just a few cells, is that a reasonable belief to impose on society at large? Could early-term abortions be closer to “a sin that’s legal” like contraception{% fn 6 %}?
